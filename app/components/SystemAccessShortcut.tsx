...
export default function SystemAccessShortcut() {
  ...
  return (
    <Link
      ...
      className="xg-safe-top fixed right-3 top-3 z-[80] inline-flex h-11 items-center gap-2 border-[3px] border-[#d8ff3e]/60 bg-black/90 px-3 text-[10px] font-black uppercase tracking-[.12em] text-[#d8ff3e] shadow-[4px_4px_0_rgba(0,0,0,.5)] backdrop-blur transition hover:border-white hover:text-white sm:right-4 sm:top-3.5"
    >
