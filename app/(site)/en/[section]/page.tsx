...
function TrainingPage() {
  return (
    <>
      ...
      <CtaBand eyebrow="Start training" title="Choose your plan and make today count." message="Hello Xtreme Gym, I would like to learn more about your training areas." cta="Talk to reception" />
    </>
  );
}
...
function PricesPage() {
  return (
    <>
      ...
      <CtaBand eyebrow="Need help?" title="We will help you choose the right plan." message="Hello Xtreme Gym, I need help choosing a membership plan." cta="Ask reception" />
    </>
  );
}
