 ...
 *
 * `code` de las máquinas (`kind: "machine"`) usa el esquema prefijo-por-área +
 * número de dos dígitos (PI-01, CA-01, RI-01, RD-01, ZC-01, PA-01...),
...
export const DEFAULT_EQUIPMENT_ASSETS: SeedRow[] = [
  ...
  { id: "eq-003", area: "Piernas", kind: "machine", code: "PI-03", name: "Abductor / Aductor (dual)", description: "Un equipo, dos estaciones.", location: "Planta baja - zona techada (frente a juegos/comida/baños)", status: "bueno", machineGuideId: "hip-abductor-aductor-dual" },
  { id: "eq-004", area: "Piernas", kind: "machine", code: "PI-04", name: "Sentadilla péndulo", location: "Planta baja - zona techada (frente a juegos/comida/baños)", status: "bueno", machineGuideId: "pendulum-squat" },
  { id: "eq-005", area: "Piernas", kind: "machine", code: "PI-05", name: "Prensa inclinada", description: "Número compartido con otra prensa en otra zona.", location: "Planta baja - frente a bronceado / venta de batidos", status: "bueno", machineGuideId: "leg-press-incline" },
  { id: "eq-006", area: "Piernas", kind: "machine", code: "PI-06", name: "Prensa horizontal", location: "Planta baja - zona techada (frente a juegos/comida/baños)", status: "fuera_de_servicio", machineGuideId: "horizontal-leg-press" },
  { id: "eq-007", area: "Piernas", kind: "machine", code: "PI-07", name: "Sentadilla acostado", description: "Confirmada por rótulo en foto.", location: "Planta baja - zona techada (frente a juegos/comida/baños)", status: "bueno", machineGuideId: "lying-squat" },
  { id: "eq-008", area: "Piernas", kind: "machine", code: "PI-08", name: "Leg Extension", description: "Primera unidad registrada.", location: "Planta baja - zona techada (frente a juegos/comida/baños)", status: "bueno", machineGuideId: "leg-extension" },
  { id: "eq-009", area: "Piernas", kind: "machine", code: "PI-09", name: "Leg Extension", description: "Segunda unidad, morada/amarilla, rótulo Xtreme Gym.", location: "Planta baja - zona techada (frente a juegos/comida/baños)", status: "bueno", machineGuideId: "leg-extension" },
  { id: "eq-010", area: "Piernas", kind: "machine", code: "PI-10", name: "Leg Curl sentado", description: "Confirmado en ficha física llenada por Kengie.", location: "Planta baja - cerca de los sanitarios", status: "bueno", machineGuideId: "leg-curl" },
  { id: "eq-011", area: "Piernas", kind: "machine", code: "PI-11", name: "Leg Curl + Leg Extension (dual)", description: "Un equipo, dos estaciones — distinta a la #26 Cybex.", location: "Planta baja - zona techada (frente a juegos/comida/baños)", status: "bueno", machineGuideId: "leg-curl-extension-dual" },
  { id: "eq-012", area: "Piernas", kind: "machine", code: "PI-12", name: "Leg Curl acostado (camilla)", location: "Planta baja - zona techada (frente a juegos/comida/baños)", status: "bueno", machineGuideId: "lying-leg-curl" },
  { id: "eq-013", area: "Piernas", kind: "machine", code: "PI-13", name: "Máquina Smith libre", location: "Planta baja - frente a bronceado / venta de batidos", status: "bueno", machineGuideId: "smith-machine" },
  { id: "eq-014", area: "Piernas", kind: "machine", code: "PI-14", name: "Sentadilla potro", location: "Planta baja - frente a bronceado / venta de batidos", status: "bueno", machineGuideId: "sentadilla-potro" },
  { id: "eq-015", area: "Piernas", kind: "machine", code: "PI-15", name: "Pantorrilla horizontal", location: "Planta baja - zona techada (frente a juegos/comida/baños)", status: "bueno", machineGuideId: "calf-press-horizontal" },
  ...
  // ── Cardio (23) ────────────────────────────────────────────────────
  { id: "eq-078", area: "Cardio", kind: "machine", code: "CA-01", name: "Cinta de correr (caminadora) #1", location: "Planta baja - área de máquinas de correr", status: "bueno", machineGuideId: "treadmill" },
  { id: "eq-079", area: "Cardio", kind: "machine", code: "CA-02", name: "Cinta de correr (caminadora) #2", location: "Planta baja - área de máquinas de correr", status: "fuera_de_servicio", machineGuideId: "treadmill" },
  { id: "eq-080", area: "Cardio", kind: "machine", code: "CA-03", name: "Cinta de correr (caminadora) #3", location: "Planta baja - área de máquinas de correr", status: "bueno", machineGuideId: "treadmill" },
  { id: "eq-081", area: "Cardio", kind: "machine", code: "CA-04", name: "Cinta de correr (caminadora) #4", location: "Planta baja - área de máquinas de correr", status: "bueno", machineGuideId: "treadmill" },
  { id: "eq-082", area: "Cardio", kind: "machine", code: "CA-05", name: "Cinta de correr (caminadora) #5", location: "Planta baja - área de máquinas de correr", status: "fuera_de_servicio", machineGuideId: "treadmill" },
  { id: "eq-083", area: "Cardio", kind: "machine", code: "CA-06", name: "Cinta de correr (caminadora) #6", location: "Planta baja - área de máquinas de correr", status: "fuera_de_servicio", machineGuideId: "treadmill" },
  { id: "eq-084", area: "Cardio", kind: "machine", code: "CA-07", name: "Cinta de correr (caminadora) #7", location: "Planta baja - área de máquinas de correr", status: "bueno", machineGuideId: "treadmill" },
  { id: "eq-085", area: "Cardio", kind: "machine", code: "CA-08", name: "Cinta de correr (caminadora) #8", location: "Planta baja - área de máquinas de correr", status: "bueno", machineGuideId: "treadmill" },
  { id: "eq-086", area: "Cardio", kind: "machine", code: "CA-09", name: "Cinta de correr (caminadora) #9", location: "Planta baja - área de máquinas de correr", status: "bueno", machineGuideId: "treadmill" },
  { id: "eq-087", area: "Cardio", kind: "machine", code: "CA-10", name: "Cinta de correr (caminadora) #10", location: "Planta baja - área de máquinas de correr", status: "bueno", machineGuideId: "treadmill" },
  { id: "eq-088", area: "Cardio", kind: "machine", code: "CA-11", name: "Cinta de correr (caminadora) #11", location: "Planta baja - área de máquinas de correr", status: "bueno", machineGuideId: "treadmill" },
  { id: "eq-089", area: "Cardio", kind: "machine", code: "CA-12", name: "Cinta de correr (caminadora) #12", description: "Estado no mencionado explícitamente en el recuento de voz.", location: "Planta baja - área de máquinas de correr", status: "pendiente", machineGuideId: "treadmill" },
  { id: "eq-090", area: "Cardio", kind: "machine", code: "CA-13", name: "Cinta de correr (caminadora) #13", location: "Planta baja - área de máquinas de correr", status: "bueno", machineGuideId: "treadmill" },
  { id: "eq-091", area: "Cardio", kind: "machine", code: "CA-14", name: "Cinta de correr (caminadora) #14", location: "Planta baja - área de máquinas de correr", status: "bueno", machineGuideId: "treadmill" },
  { id: "eq-092", area: "Cardio", kind: "machine", code: "CA-15", name: "Cinta de correr (caminadora) - otro lado #1", description: "Marca por confirmar en campo.", location: "Planta baja - área de máquinas de correr", status: "fuera_de_servicio", machineGuideId: "treadmill" },
  { id: "eq-093", area: "Cardio", kind: "machine", code: "CA-16", name: "Cinta de correr (caminadora) - otro lado #2", description: "Marca por confirmar en campo.", location: "Planta baja - área de máquinas de correr", status: "fuera_de_servicio", machineGuideId: "treadmill" },
  { id: "eq-094", area: "Cardio", kind: "machine", code: "CA-17", name: "Cinta de correr (caminadora) - otro lado #3", description: "Marca por confirmar en campo.", location: "Planta baja - área de máquinas de correr", status: "fuera_de_servicio", machineGuideId: "treadmill" },
  { id: "eq-095", area: "Cardio", kind: "machine", code: "CA-18", name: "Cinta de correr (caminadora) - otro lado #4", description: "Marca por confirmar en campo.", location: "Planta baja - área de máquinas de correr", status: "fuera_de_servicio", machineGuideId: "treadmill" },
  { id: "eq-096", area: "Cardio", kind: "machine", code: "CA-19", name: "Caminadora tipo escalera/pasos (stepper)", location: "Planta baja - área de máquinas de correr", status: "sin_dato", machineGuideId: "stair-stepper" },
  { id: "eq-097", area: "Cardio", kind: "machine", code: "CA-20", name: "Caminadora tipo escalera/pasos (stepper)", location: "Planta baja - área de máquinas de correr", status: "sin_dato", machineGuideId: "stair-stepper" },
  { id: "eq-098", area: "Cardio", kind: "machine", code: "CA-21", name: "Caminadora tipo escalera/pasos (stepper)", location: "Planta baja - área de máquinas de correr", status: "sin_dato", machineGuideId: "stair-stepper" },
  { id: "eq-099", area: "Cardio", kind: "machine", code: "CA-22", name: "Máquina de gradas (stair climber)", location: "Planta baja - área de máquinas de correr", status: "sin_dato", machineGuideId: "stair-climber" },
  { id: "eq-100", area: "Cardio", kind: "machine", code: "CA-23", name: "Máquina de gradas (stair climber)", location: "Planta baja - área de máquinas de correr", status: "sin_dato", machineGuideId: "stair-climber" },

  // ── Recepción - Izquierda (12) ─────────────────────────────────────
  { id: "eq-101", area: "Recepción - Izquierda", kind: "machine", code: "RI-01", name: "Remo cerrado (Hammer Strength)", location: "Recepción - Izquierda - Piso", status: "sin_dato", machineGuideId: "remo-hammer-strength" },
  { id: "eq-102", area: "Recepción - Izquierda", kind: "machine", code: "RI-02", name: "Dominada asistida", description: "Hay dos unidades marcadas como #2.", location: "Recepción - Izquierda - Piso", status: "sin_dato", machineGuideId: "dominada-asistida" },
  { id: "eq-103", area: "Recepción - Izquierda", kind: "machine", code: "RI-03", name: "Dominada asistida (segunda unidad)", description: "Duplicado del número 2.", location: "Recepción - Izquierda - Piso", status: "sin_dato", machineGuideId: "dominada-asistida" },
  { id: "eq-104", area: "Recepción - Izquierda", kind: "machine", code: "RI-04", name: "Jalón (polea)", location: "Recepción - Izquierda - Piso", status: "sin_dato", machineGuideId: "lat-pulldown" },
  { id: "eq-105", area: "Recepción - Izquierda", kind: "machine", code: "RI-05", name: "Remo Hammer", description: "Número dañado / difícil de leer, probable #6.", location: "Recepción - Izquierda - Piso", status: "sin_dato", machineGuideId: "remo-hammer" },
  { id: "eq-106", area: "Recepción - Izquierda", kind: "machine", code: "RI-06", name: "Remo T", location: "Recepción - Izquierda - Piso", status: "sin_dato", machineGuideId: "remo-t" },
  { id: "eq-107", area: "Recepción - Izquierda", kind: "machine", code: "RI-07", name: "Prensa de hombros (asiento, peso atrás, empuje hacia arriba y al frente)", location: "Recepción - Izquierda - Piso", status: "sin_dato", machineGuideId: "shoulder-press" },
  { id: "eq-108", area: "Recepción - Izquierda", kind: "machine", code: "RI-08", name: "Bicicleta", location: "Recepción - Izquierda - Piso", status: "sin_dato", machineGuideId: "bicicleta-estatica" },
  { id: "eq-109", area: "Recepción - Izquierda", kind: "machine", code: "RI-09", name: "Caminadora", location: "Recepción - Izquierda - Piso", status: "sin_dato", machineGuideId: "treadmill" },
  { id: "eq-110", area: "Recepción - Izquierda", kind: "machine", code: "RI-10", name: "Máquina multi-estación (asiento ajustable, soporte de espalda, plataforma frontal, agarraderas múltiples)", description: "Nombre/uso exacto pendiente de definir.", location: "Recepción - Izquierda - Piso", status: "sin_dato", machineGuideId: "multiestacion-recepcion" },
  { id: "eq-111", area: "Recepción - Izquierda", kind: "machine", code: "RI-11", name: "Máquina de gradas (stepper) - unidad 1", location: "Recepción - Izquierda - Piso", status: "sin_dato", machineGuideId: "stair-stepper" },
  { id: "eq-112", area: "Recepción - Izquierda", kind: "machine", code: "RI-12", name: "Máquina de gradas (stepper) - unidad 2", location: "Recepción - Izquierda - Piso", status: "sin_dato", machineGuideId: "stair-stepper" },

  // ── Recepción - Derecha (10) ───────────────────────────────────────
  { id: "eq-113", area: "Recepción - Derecha", kind: "machine", code: "RD-01", name: "Press plano", location: "Recepción - Derecha - Piso", status: "sin_dato", machineGuideId: "chest-press" },
  { id: "eq-114", area: "Recepción - Derecha", kind: "machine", code: "RD-02", name: "Aperturas posteriores / Pec Deck Rear Delt (Fly Rear Delt)", location: "Recepción - Derecha - Piso", status: "sin_dato", machineGuideId: "rear-delt-fly" },
  { id: "eq-115", area: "Recepción - Derecha", kind: "machine", code: "RD-03", name: "Overhead press (press militar)", location: "Recepción - Derecha - Piso", status: "sin_dato", machineGuideId: "overhead-press-machine" },
  ...
  // ── Zona Central (5) ───────────────────────────────────────────────
  { id: "eq-123", area: "Zona Central", kind: "machine", code: "ZC-01", name: "Predicador (Pressure Curve), asistido", location: "Zona Central - Debajo del reloj", status: "sin_dato", machineGuideId: "preacher-curl" },
  { id: "eq-124", area: "Zona Central", kind: "machine", code: "ZC-02", name: "Predicador (marca amarilla)", description: "Duplicado del número 12.", location: "Zona Central - Debajo del reloj", status: "sin_dato", machineGuideId: "preacher-curl" },
  { id: "eq-125", area: "Zona Central", kind: "machine", code: "ZC-03", name: "Extensión de codo", location: "Zona Central - Debajo del reloj", status: "sin_dato", machineGuideId: "elbow-extension" },
  { id: "eq-126", area: "Zona Central", kind: "machine", code: "ZC-04", name: "Fondos (dips)", description: "Duplicado del número 13.", location: "Zona Central - Debajo del reloj", status: "sin_dato", machineGuideId: "dip-machine" },
  { id: "eq-127", area: "Zona Central", kind: "machine", code: "ZC-05", name: "Polea crossover, 4 estaciones (banquita, apoyo de rodillas, poleas abajo, polea arriba)", location: "Zona Central - Debajo del reloj", status: "sin_dato", machineGuideId: "polea-crossover" },

  // ── Poleas adicionales (4) ─────────────────────────────────────────
  { id: "eq-128", area: "Poleas adicionales", kind: "machine", code: "PA-01", name: "Polea (cable)", location: "Poleas adicionales - Frente a caminadoras", status: "sin_dato", machineGuideId: "cable-station" },
  { id: "eq-129", area: "Poleas adicionales", kind: "machine", code: "PA-02", name: "Polea roja - unidad 1", location: "Poleas adicionales - Frente al VIP", status: "sin_dato", machineGuideId: "cable-station" },
  { id: "eq-130", area: "Poleas adicionales", kind: "machine", code: "PA-03", name: "Polea roja - unidad 2", location: "Poleas adicionales - Frente al VIP", status: "sin_dato", machineGuideId: "cable-station" },
